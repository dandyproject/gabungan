...
module.exports = msgHandler = async (client = new Client(), message) => {
    try {
        ...
        case 'menuadmin':
            ...
            break
            case 'hi':
              client.sendFile(from, '../../img/yumli.jpg', 'Tutor.jpg', `Hai *${pushname}*`, message.id)
              break
        case 'do':
        case 'don':
...
${biography}
-------------------------------------------------------------------
_*Stalk Instagram by @dandisubhani_*_`
        ...
        case 'tagall':
            ...
            client.sendFileFromUrl(from, kya, 'Dog.jpeg', 'Anjing', message.id)
            break
        case 'neko':  
        case 'kucing':        
        ...
        case 'stiker': 
            ...
            if ((isMedia || isQuotedImage) && args.length === 0) {
				...
				await.client.reply(from, `Hai ${pushname},Tunggu eaa stiker sedang dibuat...`, message.id)
        ...
        case 'status':{
            ...
            client.sendText(from, `Status :\n- *${loadedMsg}* Pesan Belum Terbaca\n- *${groups.length}* Grup\n- *${chatIds.length - groups.length}* Chat Pribadi\n- *${chatIds.length}* Jumlah Semua Chat`)
            break
        }
        default:
